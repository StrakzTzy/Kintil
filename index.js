...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('Masukkan Nomer Yang Ingin Di Jadikan Bot\nContoh : 15017812014\nYoutube : maapuluh\n');
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/15017812014`})
...
connectToWhatsApp();
  ...
  haikal.sendMessage('15017812014' + "@s.whatsapp.net", { text: `Berhasil Terhubung\nScript : Iam Strakz\nStatus : Sukses Pairing ✅\nRecode'an : Mas Bro\nVersion : 23` });
}
