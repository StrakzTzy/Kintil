...
let { key } = await haikal.sendMessage(from, {text: 'Searching Command...'})//Pengalih isu
...
case 'farrel': {
await loading() 
let otp =`Hay Kak ${pushname} 👋 Selamat ${salam}
...
❏ ꜱᴇʟꜰ
▬▭▬▭▬▭▬▭▬▬▭▬▭▬`
haikal.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/e0dfa48563a24f83454f9.jpg` }, mentions: [m.sender], caption: `${otp}` }, { quoted: hw })
} Kizyy = fs.readFileSync('./database/Audio/Kizyy.mp3')
await sleep (3000) 
haikal.sendMessage(m.chat, {audio: Kizyy, mimetype:'audio/mpeg', ptt:true }, {quoted:hw})
break
...
if (!text) return reply(`Penggunaan Salah Harusnya ${prefix+command} Mas relsz`)
...
case 'addprem':
if (!isCreator) return 
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 15017812014`)
...
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 15017812014*`)
if (args[1]) {
...
"inviteExpiration": `MY NAME StrakzTzy${buttonkal}`,
"groupName": `MY NAME StrakzTzy${buttonkal}`,
"caption": `${buttonkal}`,
...
"sellerJid": "15017812014@s.whatsapp.net",
...
if (args[0].startsWith(`+15017812014`)) return reply('Tidak bisa call ke nomor ini!')
...
mediaType:  1,
mediaUrl: 'https://wa.me/15017812014',
title: `HW MODS WA`,
sourceUrl: `https://wa.me/15017812014`, 
thumbnail: thumb
}
}})
break
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281545530918',
title: `HANZ MODDERZ`,
sourceUrl: `https://wa.me/6281545530918`, 
thumbnail: thumb}}},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
...
if (!isCreator) return m.reply('*Khusus Premium*')
await loading ()
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 15017812014@s.whatsapp.net`)
